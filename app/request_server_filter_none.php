    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
		  ...
		  <br/>
		 <!-- <button type="submit" class="btn btn-primary " onclick="window.location='request_server_filter_nearest.php';">Filter by Nearest</button>
		  <button type="submit" class="btn btn-primary" onclick="window.location='request_server_filter_rating.php';">Filter by Rating</button>
      <p><br/></p>-->
	  ...
	  foreach($experts as $expert)
	  {
         ...
         <div class="col-lg-3 col-md-6 mb-4" onclick="window.location='request_server_details.php?ExpertID=<?=$expert['ID']?>';">
          <div class="">
            <img class="card-img-top rounded-circle" src="images/user_pic.png" alt="">
            <div class="card-body">
              <h4 class="card-title"><?=$expert['Name']?></h4>
              <p class="card-text" style="color:blue">Experience: <?=dateDifference($expert['SignInDate'])?></p>
              <p class="card-text"><?=$expert['Address']?></p>
              <p> 
					<?php 
					if(!empty($expert['Rating']))
					{
