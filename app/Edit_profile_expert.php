...
<?php
	...
	{
		$Expert['Name']=$_POST['name'];
		$Expert['Address']=$_POST['address'];
		$Expert['PhoneNumber']=$_POST['phone'];
		users_Update($Expert);
		$sv=true;
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
	 ...
	 <?php
		if(($_SERVER['REQUEST_METHOD']=="POST")&&($sv))
		{
     ...
     <div class="row">
        <div class="col-8">
          <table class="table table-striped" style="width: 80%">
            <tr>
              <td width="40%">Name</td>
              <td class="text-justify"><input type="text" name="name" value="<?=$Expert['Name']?>"/></td>
            </tr>
            <tr >
              <td width="40%">Email</td>
              <td class="text-justify"><?=$Expert['Email']?></td>
            </tr>
            <tr >
              <td width="40%">Address</td>
              <td>
                <textarea id="Address" name="address" style="height:100px;width:300px"><?=$Expert['Address']?></textarea>
              </td>
            </tr>
            <tr >
              <td width="40%">Phone number</td>
              <td class="text-justify"><input type="text" name="phone" value="<?=$Expert['PhoneNumber']?>"/></td>
            </tr>
          </table>
        </div>
        <div class="col-4"  style="padding-right: 100px">
           <img src="images/user_pic.png" style="width:100%">
        </div>
     </div>
