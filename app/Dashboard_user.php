  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <table class="table table-filter table-primary table-striped">
		<tbody>
		<?php
			$requests=requests_GetByCustomerIDPending($_SESSION['Customer']['ID']);
			if(sizeof($requests)==0){
				echo "<h2> No Pending Request</h2>";
			}
			foreach($requests as $request)
			{
				?>
			<tr style="cursor:pointer" onclick="window.location='Customer_request_status.php?Request=<?=$request['RequestID']?>';">
				...
				<td width="75%">
					<div class="media">
						...
						<div class="media-body" >
							...
							<h4 class="title">
								&nbsp <?=users_GetByID($request['ExpertID'])['Name']?>
				...
				<td >
					<button type="button"  style="cursor:default;"  class="btn btn-warning text-white"><b><?=$request['Status']?></b></button>
				</td>
				<td width="20%">
