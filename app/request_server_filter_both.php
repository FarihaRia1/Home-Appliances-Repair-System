    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
		  ...
		  <br/>
		  <button type="submit" class="btn btn-danger float-right" onclick="window.location='request_server_filter_rating.php';">Filter by Nearest  <span aria-hidden="true">&times;</span></button>
		  <button type="submit" class="btn btn-danger float-right" onclick="window.location='request_server_filter_nearest.php';">Filter by Rating <span aria-hidden="true">&times;</span></button>
