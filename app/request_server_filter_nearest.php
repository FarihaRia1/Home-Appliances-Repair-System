    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
		  ...
		  <br/>
		  <button type="submit" class="btn btn-primary" onclick="window.location='request_server_filter_both.php';">Filter by Rating</button>
		  <button type="submit" class="btn btn-danger float-right" onclick="window.location='request_server_filter_none.php';">Filter by Nearest <span aria-hidden="true">&times;</span></button>
