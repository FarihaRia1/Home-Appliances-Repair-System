    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <h1>Messages</h1>
		  <br/>
		  <button type="submit" class="btn btn-danger  float-right" onclick="window.location='messages_filter_none.php';">Filter by Unseen <span aria-hidden="true">&times;</span></button>
		  <br/><br/>
